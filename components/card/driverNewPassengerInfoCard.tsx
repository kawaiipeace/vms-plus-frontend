...
export default function DriverNewPassengerInfoCard({
  id,
  requestData,
  displayLocation,
    ...
    <div className="form-card">
      <div className="form-card-body">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold">{requestData?.vehicle_user_emp_name || "-"}</p>
            <p className="font-light">{requestData?.vehicle_user_dept_name_short || "-"}</p>
          </div>
        </div>
        <div className="mt-3">
          <div className="grid grid-cols-4 gap-3">
            <div className="flex items-center col-span-3">
              ...
              <p> {requestData?.car_user_mobile_contact_number || "-"}</p>
            </div>
      ...
      <CallToDriverModal
        imgSrc={requestData?.vehicle_user_image_url || "/assets/img/avatar.svg"}
        name={requestData?.vehicle_user_emp_name || "-"}
        phone={requestData?.car_user_mobile_contact_number || "-"}
