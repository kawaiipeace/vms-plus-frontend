...
export default function MobileRecordTravelCard({ reviewCarDrive, returnCarAdd }: MobileRecordTravelCardProps) {
  return (
    <div className="card">
      <div className="card-body">
        <div className="card-body-inline">
          <div className="img img-square img-avatar flex-grow-1 align-self-start">
            <Image src="/assets/img/graphic/status_vehicle_inuse.png" width={100} height={100} alt="" />
          </div>
          <div className="card-content">
            <div className="card-content-top">
              <div className="card-title">
                บันทึกการเดินทาง <i className="material-symbols-outlined icon-settings-400-20">keyboard_arrow_right</i>
              </div>
        ...
        <div className="card-actions card-actions-column">
          ...
          <button className="btn btn-secondary" onClick={returnCarAdd}>
            คืนยานพาหนะ <i className="material-symbols-outlined icon-settings-fill-300-24 text-error">error</i>
          </button>
        </div>
      </div>
    </div>
