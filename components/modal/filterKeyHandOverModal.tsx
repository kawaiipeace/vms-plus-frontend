...
const FilterKeyHandOverModal = forwardRef((_, ref) => {
  ...
  const [options, setOptions] = useState<{ value: string; label: string | React.ReactNode }[]>([]);
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12">
              <div className="form-group">
                ...
                <CustomSelect w="100" options={options} value={selectedOption} onChange={setSelectedOption} />
              </div>
            </div>
