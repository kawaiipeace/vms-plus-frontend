      ...
      if (startDate && startTime && endDate && endTime && startLocation && endLocation && startMile && endMile) {
        const submitForm = async () => {
          try {
            ...
            const res = role === "user" ? await UserCreateTravelDetail(payload) : await UserCreateTravelDetail(payload);
            const data = res.data;
            if (data) {
              modalRef.current?.close();
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        onChange={(e) => {
                          setValue((val) => ({ ...val, startMile: e.target.value }));
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        value={value?.endMile}
                        onChange={(e) => {
                          setValue((val) => ({ ...val, endMile: e.target.value }));
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        onChange={(e) => {
                          setValue((val) => ({ ...val, startLocation: e.target.value }));
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        onChange={(e) => {
                          setValue((val) => ({ ...val, endLocation: e.target.value }));
                        }}
                      />
                    </div>
                  </div>
                    ...
                    <div className="form-group">
                      ...
                      <div className="input-group">
                        <input
                          ...
                          value={value?.detail}
                          onChange={(e) => {
                            setValue((val) => ({ ...val, detail: e.target.value }));
                          }}
                        />
                      </div>
                    </div>
