    ...
    const baseColumns = [
      columnHelper.accessor(
        ...
        }),
        {
          ...
          enableSorting: false,
          meta: {
            className: `sticky left-0 z-0 bg-white min-w-[180px] max-w-[180px] border-b border-gray-500 ${
      ...
      selectedOption === "all"
        ? [
            columnHelper.accessor("vehicleType", {
              ...
              meta: {
                className:
                  "hidden sm:table-cell sticky left-[180px] z-0 bg-white min-w-[155px] max-w-[155px] border-b border-gray-500",
              },
            }),
            columnHelper.accessor("vehicleDepartment", {
              ...
              meta: {
                className:
                  "sm:table-cell hidden sticky left-[335px] z-0 bg-white min-w-[170px] max-w-[170px] border-b border-gray-500",
              },
            }),
            columnHelper.accessor("distance", {
              ...
              enableSorting: true,
              meta: {
                className: `sm:table-cell hidden sticky left-[505px] z-0 bg-white min-w-[150px] max-w-[150px] fixed-column-line border-b border-gray-500 ${
                  selectedOption === "all" && "border-r"
                }`,
              },
            }),
