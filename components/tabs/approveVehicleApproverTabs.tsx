...
import { fetchFinalApproverMenus } from "@/services/bookingApprover";
import { summaryType } from "@/app/types/request-list-type";
import DriverLicApproveFlow from "../flow/driverLicApproveFlow";

export default function ApproveVehicleApproverTabs() {
  ...
  useEffect(() => {
    ...
    const fetchMenuFunc = async () => {
      try {
        const response = await fetchFinalApproverMenus();
