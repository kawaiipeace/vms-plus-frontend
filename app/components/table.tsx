                  ...
                  <td key={cell.id} className="p-2">
                    {cell.column.columnDef.header === "สถานะคำขอ" ? (
                      <div className="w-full text-center">
                        <span className="badge badge-pill-outline badge-error">{cell.renderValue() as React.ReactNode}</span>
                      </div>
                    ) : cell.column.columnDef.header === "" ? (
                      <>
                        <div className="dt-action">
                          <button className="btn btn-icon btn-tertiary bg-transparent shadow-none border-none tooltip tooltip-left" data-tip="ดูรายละเอียดคำขอ" onClick={() => router.push("request-list/1")}>
                            <i className="material-symbols-outlined icon-settings-fill-300-24">quick_reference_all</i>
                          </button>
                          <button className="btn btn-icon btn-tertiary bg-transparent shadow-none border-none tooltip tooltip-left" data-tip="แก้ไข" onClick={() => router.push("request-list/edit/1")}>
