        ...
        <>
          <div className="grid grid-cols-1 gap-4">
            <div>
              ...
              <div className="grid grid-cols-1 gap-4">
                <MobileDriverCard cardType="cancel" carRegis="5กก 1234 กรุงเทพมหานคร" location="การไฟฟ้าเขต ฉ.1 และ กฟฟ. ในสังกัด..." date="01/01/2567 - 07/01/2567" title="ยกเลิกภารกิจ" noteText="งานถูกยกเลิกแล้ว 25/12/2566" />
                <MobileDriverCard cardType="cancel" carRegis="5กก 1234 กรุงเทพมหานคร" location="การไฟฟ้าเขต ฉ.1 และ กฟฟ. ในสังกัด..." date="01/01/2567 - 07/01/2567" title="ยกเลิกภารกิจ" noteText="งานถูกยกเลิกแล้ว 25/12/2566" />
              </div>
            </div>
          </div>
